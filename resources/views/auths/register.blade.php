                ...
                <div class="card-body py-4" id="wizard-controller">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active px-sm-3 px-md-5" role="tabpanel" aria-labelledby="account" id="account">
                            <div class="needs-validation" novalidate="">
                                ...
                                <div class="form-check d-none">
                                    ...
                                    <label class="form-check-label disabled" disabled for="bootstrap-wizard-validation-wizard-checkbox">Dengan ini saya menerima <a href="#!">Ketentuan </a>dan <a href="#!">Kebijakan</a> yang berlaku</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="personal" id="personal">
                            <div class="needs-validation" novalidate="">
                                <div class="mb-3">
                                    <label class="form-label" for="manager">{{ __('Pengurus Masjid') }}</label>
                        ...
                        <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="address" id="address">
                            <div class="needs-validation" novalidate="">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        <label class="form-label" for="postal_code">{{ __('Kode Pos') }}</label>
                        ...
                        <div class="tab-pane text-center px-sm-3 px-md-5" role="tabpanel" aria-labelledby="done" id="done">
                            ...
                            <h4 class="mb-1">Semua telah di isi!</h4>
                            <p>Anda bisa menyimpan akun anda dan login</p>
                            <button class="btn btn-primary px-5 my-3" type="submit">Simpan</button>
                            <button class="btn btn-danger px-5 my-3" onclick="window.reload()">Ulangi</button>
                        </div>
                    </div>
                </div>
                <div class="card-footer bg-light">
                    <div class="px-sm-3 px-md-5">
                        <ul class="pager wizard list-inline mb-0">
                            <li class="previous">
                                <button class="btn btn-link ps-0" type="button"><span class="fas fa-chevron-left me-2" data-fa-transform="shrink-3"></span>Kembali</button>
                            </li>
                            <li class="next">
                                <button class="btn btn-primary px-5 px-sm-6" type="button">Lanjut<span class="fas fa-chevron-right ms-2" data-fa-transform="shrink-3"> </span></button>
                            </li>
                        </ul>
                    </div>
                </div>
