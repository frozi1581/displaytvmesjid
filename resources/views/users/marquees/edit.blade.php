...
@section('endpoint', '/user/marquee/edit' . $data->id)

@section('breadcrumb')
<li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
<li class="breadcrumb-item active"><a href="/user/marquee">Teks Berjalan</a></li>
<li class="breadcrumb-item active"><a href="/user/marquee/edit/{{ $data->id }}">Edit</a></li>
@endsection
    ...
    <div class="card mb-3">
        ...
        <div class="card-body position-relative">
            <div class="row">
                <div class="col-lg-8">
                    <h3>Teks Berjalan</h3>
                    <p class="mb-0">Modul untuk mengatur fitur teks berjalan pada aplikasi anda.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                        <h5 class="mb-0" data-anchor="data-anchor" id="marquee__card">Teks Berjalan</h5>
                    </div>
                </div>
            </div>
            <div class="card-body bg-light">
                <div class="mb-3">
                    <label class="form-label" for="marquee__content">Konten</label>
                    <textarea class="form-control" id="marquee__content" name="content" rows="5">{{ $data->content }}</textarea>
                </div>
            </div>
...
<script>
    $('#marquee__btn').on('click', function(e) {
        ...
        if ($("#marquee__form").parsley().isValid()) {
            ...
            sendPut('/user/marquee/{{ $data->id }}', data);
        }
    });
</script>
@endsection
