                ...
                <form method="POST" action="{{ route('profile.information') }}#logo_url" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="upload-section" class="d-flex flex-col gap-4">
                            <input type="text" name="logo_url" class="d-none" value="{{ str_contains(Auth::user()->mosque->logo_url, 'ui-avatars.com') ? null : Auth::user()->mosque->logo_url }}">
                            <input id="upload-input" type="file" name="logo" class="d-none">
                            <img id="upload-preview" class="img-fluid rounded-circle shadow-sm @error('logo') is-invalid border border-danger @enderror" src="{{ Auth::user()->mosque->logo_url }}" alt="" width="100">
