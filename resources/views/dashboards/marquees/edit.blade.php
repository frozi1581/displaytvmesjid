...
@section('endpoint', '/marquee/create')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
<li class="breadcrumb-item active"><a href="/marquee">Marquee</a></li>
<li class="breadcrumb-item active"><a href="/marquee/create">Edit</a></li>
@endsection
            ...
            <div class="card-header">
                <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                        <h5 class="mb-0" data-anchor="data-anchor" id="marquee__card">Marquee</h5>
                    </div>
                </div>
            </div>
